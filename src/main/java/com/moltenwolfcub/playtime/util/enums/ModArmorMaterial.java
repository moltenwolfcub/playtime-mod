...
public enum ModArmorMaterial implements ArmorMaterial{
    ...
    NEPTUNIUM(Playtime.MOD_ID + ":neptunium", 40, new int[] { 3, 8, 6, 3 }, 17,
        SoundEvents.ARMOR_EQUIP_NETHERITE, 3.5F, () -> { return Ingredient.of(ModItems.NEPTUNIUM_INGOT.get()); }, 0.1f);
